    ...
    */
    public static java.lang.String a(java.lang.String r1) {
        ...
        L89:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p2.y.a(java.lang.String):java.lang.String");
    }

    public static String b(r4 r4Var) {
        Bundle bundle = r4Var.f22254c;
        return bundle == null ? "unspecified" : bundle.getString("query_info_type");
    }

    public static void c(final jq1 jq1Var, final zp1 zp1Var, final String str, final Pair... pairArr) {
        if (((Boolean) h2.y.c().b(ns.W6)).booleanValue()) {
            eh0.f7322a.execute(new Runnable() { // from class: p2.x
                @Override // java.lang.Runnable
                public final void run() {
                    y.d(jq1Var, zp1Var, str, pairArr);
                }
            });
        }
    }

    static void d(jq1 jq1Var, zp1 zp1Var, String str, Pair... pairArr) {
        Map mapC = zp1Var == null ? jq1Var.c() : zp1Var.a();
        f(mapC, "action", str);
    ...
    public static int e(ts2 ts2Var) {
        if (ts2Var.f15315q) {
            return 2;
        }
        r4 r4Var = ts2Var.f15302d;
        y0 y0Var = r4Var.f22270s;
        if (y0Var == null && r4Var.f22275x == null) {
            return 1;
        }
        if (y0Var == null || r4Var.f22275x == null) {
