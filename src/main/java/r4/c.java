...
public class c {
    ...
    private File a() {
        if (this.f25900a == null) {
            synchronized (this) {
                if (this.f25900a == null) {
                    this.f25900a = new File(this.f25901b.l().getFilesDir(), "PersistedInstallation." + this.f25901b.r() + ".json");
                }
            }
        }
        return this.f25900a;
    ...
    public d b(d dVar) {
        try {
            ...
            File fileCreateTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f25901b.l().getFilesDir());
