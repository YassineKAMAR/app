...
public class a extends c<Boolean> {
    ...
    private static final String f20947i = j.f("BatteryChrgTracker");
    ...
    */
    public void h(android.content.Context r6, android.content.Intent r7) {
        ...
        L7:
            x0.j r7 = x0.j.c()
            java.lang.String r0 = d1.a.f20947i
            r1 = 1
        ...
        L5e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: d1.a.h(android.content.Context, android.content.Intent):void");
    }
    ...
    public Boolean b() {
        ...
        j.c().b(f20947i, "getInitialState - null intent received", new Throwable[0]);
        return null;
    }
}
