...
public class o extends MultiAutoCompleteTextView {
    ...
    private static final int[] f1046c = {R.attr.popupBackground};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final e f1047a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final d0 f1048b;
    ...
    public o(Context context, AttributeSet attributeSet, int i8) {
        ...
        l1 l1VarU = l1.u(getContext(), attributeSet, f1046c, i8, 0);
        if (l1VarU.r(0)) {
