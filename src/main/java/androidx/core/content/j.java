...
public class j extends ContentProvider {
    ...
    private static final String[] f1943c = {"_display_name", "_size"};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final File f1944d = new File("/");

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final HashMap<String, b> f1945e = new HashMap<>();
    ...
    static class c implements b {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final HashMap<String, File> f1949b = new HashMap<>();

        c(String str) {
            this.f1948a = str;
        }

        @Override // androidx.core.content.j.b
        public File a(Uri uri) {
            String encodedPath = uri.getEncodedPath();
            int iIndexOf = encodedPath.indexOf(47, 1);
            String strDecode = Uri.decode(encodedPath.substring(1, iIndexOf));
            String strDecode2 = Uri.decode(encodedPath.substring(iIndexOf + 1));
            File file = this.f1949b.get(strDecode);
            if (file == null) {
        ...
        public Uri b(File file) {
            try {
                ...
                for (Map.Entry<String, File> entry2 : this.f1949b.entrySet()) {
                ...
                return new Uri.Builder().scheme("content").authority(this.f1948a).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(canonicalPath.substring(length), "/")).build();
            } catch (IOException unused) {
        ...
        void c(String str, File file) {
            ...
            try {
                this.f1949b.put(str, file.getCanonicalFile());
    ...
    private static b e(Context context, String str, int i8) {
        b bVarH;
        HashMap<String, b> map = f1945e;
        synchronized (map) {
            bVarH = map.get(str);
            if (bVarH == null) {
                try {
                    try {
                        bVarH = h(context, str, i8);
                        map.put(str, bVarH);
                    } catch (IOException e8) {
    ...
    private static b h(Context context, String str, int i8) throws XmlPullParserException, IOException {
        c cVar = new c(str);
        XmlResourceParser xmlResourceParserD = d(context, str, context.getPackageManager().resolveContentProvider(str, 128), i8);
        while (true) {
            ...
            if (next == 2) {
                ...
                if ("root-path".equals(name)) {
                    externalStorageDirectory = f1944d;
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        this.f1946a = e(context, str, this.f1947b);
    }

    @Override // android.content.ContentProvider
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f1946a.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File fileA = this.f1946a.a(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) {
        return ParcelFileDescriptor.open(this.f1946a.a(uri), g(str));
    }
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        String[] strArrC = c(strArr3, i9);
        Object[] objArrB = b(objArr, i9);
