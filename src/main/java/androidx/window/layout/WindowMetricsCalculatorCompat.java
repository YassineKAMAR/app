...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    static {
        ...
        q.e(simpleName, "WindowMetricsCalculatorC…at::class.java.simpleName");
        TAG = simpleName;
    }
    ...
    public WindowMetrics computeCurrentWindowMetrics(Activity activity) {
        ...
        return new WindowMetrics(i8 >= 30 ? ActivityCompatHelperApi30.INSTANCE.currentWindowBounds(activity) : i8 >= 29 ? computeWindowBoundsQ$window_release(activity) : i8 >= 28 ? computeWindowBoundsP$window_release(activity) : i8 >= 24 ? computeWindowBoundsN$window_release(activity) : computeWindowBoundsIceCreamSandwich$window_release(activity));
    }
    ...
    public final Rect computeWindowBoundsP$window_release(Activity activity) {
        ...
        q.e(currentDisplay, "currentDisplay");
        ...
        if (!activityCompatHelperApi24.isInMultiWindowMode(activity)) {
            ...
            if (i8 + navigationBarHeight == point.y) {
                rect2.bottom = i8 + navigationBarHeight;
            } else {
                int i9 = rect2.right;
                if (i9 + navigationBarHeight == point.x) {
                    rect2.right = i9 + navigationBarHeight;
