...
public final class HardwareFoldingFeature implements FoldingFeature {
    ...
    public boolean equals(Object obj) {
        ...
        if (!q.b(HardwareFoldingFeature.class, obj == null ? null : obj.getClass())) {
            return false;
        }
        if (obj == null) {
        ...
        return q.b(this.featureBounds, hardwareFoldingFeature.featureBounds) && q.b(this.type, hardwareFoldingFeature.type) && q.b(getState(), hardwareFoldingFeature.getState());
    }
    ...
    public boolean isSeparating() {
        ...
        if (q.b(type, companion.getHINGE())) {
            return true;
        }
        return q.b(this.type, companion.getFOLD()) && q.b(getState(), FoldingFeature.State.HALF_OPENED);
    }
