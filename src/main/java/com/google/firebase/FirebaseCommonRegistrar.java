...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<c<?>> getComponents() {
        ...
        arrayList.add(h.c("android-target-sdk", new h.a() { // from class: c4.g
            @Override // v4.h.a
            public final String a(Object obj) {
                return FirebaseCommonRegistrar.e((Context) obj);
            }
        }));
        arrayList.add(h.c("android-min-sdk", new h.a() { // from class: c4.h
            @Override // v4.h.a
            public final String a(Object obj) {
                return FirebaseCommonRegistrar.f((Context) obj);
            }
        }));
        arrayList.add(h.c("android-platform", new h.a() { // from class: c4.i
            @Override // v4.h.a
            public final String a(Object obj) {
                return FirebaseCommonRegistrar.g((Context) obj);
            }
        }));
        arrayList.add(h.c("android-installer", new h.a() { // from class: c4.j
            @Override // v4.h.a
            public final String a(Object obj) {
