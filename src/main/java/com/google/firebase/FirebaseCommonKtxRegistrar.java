...
public final class FirebaseCommonKtxRegistrar implements ComponentRegistrar {
    ...
    public static final class a<T> implements h {
        ...
        public static final a<T> f20762a = new a<>();
    ...
    public static final class b<T> implements h {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final b<T> f20763a = new b<>();
    ...
    public static final class c<T> implements h {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final c<T> f20764a = new c<>();
    ...
    public static final class d<T> implements h {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final d<T> f20765a = new d<>();
    ...
    public List<f4.c<?>> getComponents() {
        f4.c cVarC = f4.c.c(e0.a(e4.a.class, b0.class)).b(r.h(e0.a(e4.a.class, Executor.class))).e(a.f20762a).c();
        q.e(cVarC, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        f4.c cVarC2 = f4.c.c(e0.a(e4.c.class, b0.class)).b(r.h(e0.a(e4.c.class, Executor.class))).e(b.f20763a).c();
        q.e(cVarC2, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        f4.c cVarC3 = f4.c.c(e0.a(e4.b.class, b0.class)).b(r.h(e0.a(e4.b.class, Executor.class))).e(c.f20764a).c();
        q.e(cVarC3, "builder(Qualified.qualif…cher()\n    }\n    .build()");
        f4.c cVarC4 = f4.c.c(e0.a(e4.d.class, b0.class)).b(r.h(e0.a(e4.d.class, Executor.class))).e(d.f20765a).c();
