...
public enum x0 {
    ...
    private static final Map<Integer, x0> C0 = new HashMap();
    ...
    static {
        for (x0 x0Var : values()) {
            C0.put(Integer.valueOf(x0Var.f19362a), x0Var);
        }
    }
    ...
    public static x0 a(int i8) {
        return C0.get(Integer.valueOf(i8));
    }

    @Override // java.lang.Enum
    public final String toString() {
        return Integer.valueOf(this.f19362a).toString();
    }
}
