...
final class CoroutinesExtensionsKt$awaitCustomerInfo$2$2 extends r implements l<PurchasesError, i0> {
    final /* synthetic */ h6.d<CustomerInfo> $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    CoroutinesExtensionsKt$awaitCustomerInfo$2$2(h6.d<? super CustomerInfo> dVar) {
        super(1);
